module.exports = class Preload extends Phaser.State {
  ...
  preload() {
    ...
    this.load.atlasJSONHash('cucumber-cutting-animation', 'assets/img/components/cucumber-cutting-animation-min.png', 'assets/img/components/cucumber-cutting-animation.json');
    this.load.atlasJSONHash('eggplant-cutting-animation', 'assets/img/components/eggplant-cutting-animation-min.png', 'assets/img/components/eggplant-cutting-animation.json');
    ...
    this.load.atlasJSONHash('tomato-cutting-animation', 'assets/img/components/tomato-cutting-animation-min.png', 'assets/img/components/tomato-cutting-animation.json');
    this.load.atlasJSONHash('paprika-cutting-animation', 'assets/img/components/paprika-cutting-animation-min.png', 'assets/img/components/paprika-cutting-animation.json');
