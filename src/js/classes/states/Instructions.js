...
export default class Instructions extends Phaser.State {
  ...
  createInstructions() {
    //page title
    this.pageTitle = this.add.text(this.world.centerX + 238, 120, `Instructies`, {font: `90px circular-medium`, fill: `#fff`});
    ...
    this.instructionText = this.add.text(this.world.centerX + 200, 380,
      `
  ...
  createVegetableSelection() {
    //te snijden groenten
    this.dishText = this.add.text(this.world.centerX + 244, this.world.centerY + 50, `Te snijden groenten:`, {font: `50px circular`, fill: `#fff`});
    ...
    //img
    this.spaghetti = this.add.image(this.world.centerX + 244, this.world.centerY + 185, `spaghetti`);
  ...
  createButton() {
    const buttonPlay = new Button(this.game, this.world.centerX + 244, this.world.height - 150, this.buttonPlayClicked, this, `button`, `Start`);
